...
final int SPEECHBUBBLE_XPOS = 250;
final int SPEECHBUBBLE_TEXT_HIGH = 200;
final int SPEECHBUBBLE_TEXT_LOW = 300;
...
class Glossary
{
  ...
  void contentSelector(int arrayIndex) { //this function defines what text/images/etc should be drawn in what glossarycontent object
    ...
    case 0: //bankrun
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Je mag gewoon blijven zitten hoor.");
    ...
    case 1: //dobbelstenen
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Als je rustig gooit kun je\nmisschien de uitkomst bepalen.");
    ...
    case 2: //promoveren/degraderen
      ...
      image(style.BagTip, AVATAR_XPOS, AVATAR_YPOS, AVATAR_SIZE, AVATAR_SIZE);
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 300, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_LOW, "Als je je schulden niet kunt betalen tijdens\neen bankrun beland je in de gevangenis.");
    ...
    case 3: //productie/consumptie
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 300, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_LOW, "Het duurste eten dat je kunt kopen is\nJapans Kobe vlees van 1000 euro per kilo.");
    ...
    case 4: //Kopen/Verkopen
      ...
      image(style.BagTip, AVATAR_XPOS, AVATAR_YPOS, AVATAR_SIZE, AVATAR_SIZE);
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 350, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Later in het spel veranderen de prijzen\nvan goederen erg snel, wacht niet te lang!");
    ...
    case 5: //goud
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Ongeveer 80% van het totale aantal goud\nop aarde is al gedolven door de mensheid.");
    ...
    case 6: //krediet
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Als je niet met krediet hoeft te\nbetalen zou ik dat ook niet doen.");
    ...
    case 7: //bank
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Het woord 'bank' is een voorbeeld van een homoniem,\neen woord met meerdere betekenissen.");
    ...
    case 8: //actie kaart
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Met actie kaarten kun je het hele spel omgooien.");
    ...
    case 9: //financierings kaart
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 350, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Het oudste bedrijf van Nederland\nis een bierbrouwerij in Wijlre:\n de Koninklijke Brand Bierbrouwerij BV.\nAl sinds 1340 is deze brouwer actief.");
    ...
    case 10: //gilde
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Een gilde is een belangenorganisatie voor mensen\ndie in dezelfde beroepsgroep werken.");
    ...
    case 11: //gevangenis
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, SPEECHBUBBLE_TEXT_HIGH, "Zebras zijn eigenlijk paarden die ontsnapt\nzijn uit de gevangenis.");
