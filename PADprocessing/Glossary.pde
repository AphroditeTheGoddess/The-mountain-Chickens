...
class Glossary
{
  ...
  void contentSelector(int arrayIndex) { //this function defines what text/images/etc should be drawn in what glossarycontent object
    ...
    case 0: //bankrun
      ...
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Je mag gewoon blijven zitten hoor.");
    ...
    case 1: //dobbelstenen
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Als je rustig gooit kun je\nmisschien de uitkomst bepalen.");
    ...
    case 2: //promoveren/degraderen
      ...
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 300, "Als je je schulden niet kunt betalen tijdens\neen bankrun beland je in de gevangenis.");
    ...
    case 3: //productie/consumptie
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 300, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 300, "Het duurste eten dat je kunt kopen is\nJapans Kobe vlees van 1000 euro per kilo.");
    ...
    case 4: //Kopen/Verkopen
      ...
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Later in het spel veranderen de prijzen\nvan goederen erg snel, wacht niet te lang!");
    ...
    case 5: //goud
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Ongeveer 80% van het totale aantal goud\nop aarde is al gedolven door de mensheid.");
    ...
    case 6: //krediet
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Als je niet met krediet hoeft te\nbetalen zou ik dat ook niet doen.");
    ...
    case 7: //bank
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Het woord 'bank' is een voorbeeld van een homoniem,\neen woord met meerdere betekenissen.");
    ...
    case 8: //actie kaart
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Met actie kaarten kun je het hele spel omgooien.");
    ...
    case 10: //gilde
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Een gilde is een belangenorganisatie voor mensen\ndie in dezelfde beroepsgroep werken.");
    ...
    case 11: //gevangenis
      ...
      image(style.glossarySpeech, SPEECHBUBBLE_XPOS, AVATAR_YPOS - 400, 500, 400);
      textSize(16);
      drawTextWithColour(style.black, style.white, SPEECHBUBBLE_XPOS, 200, "Zebras zijn eigenlijk paarden die ontsnapt\nzijn uit de gevangenis.");
